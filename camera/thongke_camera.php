...
<head>
	<<meta charset="utf-8">
        ...
        <title>Thông kế hệ thông camera</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        {
        ?>
        	<li><a href="thongke_camera.php"><em class="fa fa-bookmark">&nbsp;</em>Tổng hợp </a></li>
        <?php 
    	}
   		?>
		<?php 
        ...
        {
        ?>
        	<li><a href="thongke_camera.php?deptcamera=<?php echo $row_dept['network_dept'] ; ?>"><em class="fa fa-building">&nbsp;</em> 
        		<?php 
	 ...
	 <?php
	 	require('xuly_thongke_camera.php');

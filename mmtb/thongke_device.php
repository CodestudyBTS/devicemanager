...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        {
        	?>
        	<li><a href="thongke_device.php?deptdevice=<?php echo $row_dept['dept_id'] ; ?>"><em class="fa fa-building">&nbsp;</em> <?php echo $row_dept['dept_name'] ; ?></a></li>
        	<?php
        }
        ?>

<?php   
        ...
        $toyear = getdate();
        $prefix = $toyear['year'];
        $query_device_total = "SELECT max(device_id) as max_id  from device WHERE device_id like '$prefix%'" ;
        ...
        // Get data category 
        $query_device = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE device.device_name like '$madevice'" ;
        $result_device= mysqli_query($connect, $query_device) ; 
        $row_device_ud = mysqli_fetch_array($result_device);
        if(empty($row_device_ud['dept_id']))
        {
            $dept_device=null;
        }
        else
        {
            $dept_device=$row_device_ud['dept_id'];
        } 
        //main
        ...
        // Get data dept 
        $query_dept = "SELECT * from phongban where dept_id <> '$dept_device' " ;
...
<body>   
        <div class="container">
            ...
            <div class="panel-body">
                ...
                <div class="form-group col-lg-2">
                  ...
                  <input style="color: red; font-weight: bold;" value="<?php echo "$mathietbi" ?>" type="text" name="txtmathietbi" class="form-control" id="usr" >
                </div>
                <div class="form-group col-lg-2">
                ...
                <div class="form-group col-lg-3">
                  ...
                  <select name="txtram" class="js-example-basic-multiple form-control" id="is_mem">
                ...
                <div class="form-group col-lg-2">
                  ...
                  <select name="txtdept" class="js-example-basic-multiple form-control" id="is_dept"  oninvalid="this.setCustomValidity('Tên phòng ban không để trống')" oninput="setCustomValidity('')" required>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php 
                    if($row_device_ud['device_type'] == "PRT")
                    {

                ?>
                <!-- Get old sl bom mực -->                                 
                  <input value="<?php echo $row_device_ud['sl_bommuc']?>" type="hidden" name="txtslbommuc_old" class="form-control" id="address">
                 <div class="form-group col-lg-2">
                  <label for="email">Số lần bơm mực</label>                  
                  <select name="txtslbommuc" class="js-example-basic-multiple form-control" id="txtslbommuc" >
                    <option value="<?php echo $row_device_ud['sl_bommuc'] ;  ?>"><?php echo $row_device_ud['sl_bommuc'] ;  ?></option> 
                    <option value="Chưa bơm mực">Chưa bơm mực</option>                                   
                    <option value="1 lần">1 lần</option>
                    <option value="2 lần">2 lần</option>
                    <option value="3 lần">3 lần</option>
                    <option value="4 lần">4 lần</option> 
                    <option value="5 lần">5 lần</option> 
                    <option value="6 lần">6 lần</option> 
                    <option value="7 lần">7 lần</option>
                    <option value="8 lần">8 lần</option>
                    <option value="9 lần">9 lần</option>
                    <option value="10 lần">10 lần</option> 
                    <option value="Trên 10 lần">Trên 10 lần</option>                   
                  </select>
                </div>
                <?php 
                }
                ?>
                <?php
                if ($row_device_ud['device_type'] != "PRT" && $row_device_ud['device_type'] != "DV") 
                {
                 ?>
                <div class="col-lg-12" style="font-size: 25px; background-color: #86e686; margin-bottom: 10px; text-align: center;">
                ...
                <!-- Get old phong ban -->
                  <input value="<?php echo $row_device_ud['dept_id'] ;?>" type="hidden" name="txtphongban_old" class="form-control" id="address">
                <div class="form-group col-lg-2">
                  <label for="email">Phòng ban (*)</label>                  
                  <select name="txtdept" class="js-example-basic-multiple form-control" id="ud_dept"  oninvalid="this.setCustomValidity('Tên phòng ban không để trống')" oninput="setCustomValidity('')" required>
                    <?php 
                        if(empty($row_device_ud['dept_id']))
                        {
                            ?>
                        ...
                        {
                            ?>
                            <option value="<?php echo $row_device_ud['dept_id'] ;?>" ><?php echo $row_device_ud['dept_name'] ?></option>
                       <?php
                        }
                    ?>                                                       
                      <?php
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group col-lg-8">
                  <label for="address" style="color: #868686"> Tên thiết bị (Dành cho Printer hoặc thiết bị khác)</label>

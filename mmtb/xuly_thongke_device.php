...
<!-- count total device -->
<?php
$query_total_device = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE phongban.dept_id like '%$deptdevice%' ";
...
<!-- count pc-->
<?php
$query_total_device_pc = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE phongban.dept_id like '%$deptdevice%' AND device_type like '%PC%'  ";
...
<!-- count laptop-->
<?php
$query_total_device_laptop = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE phongban.dept_id like '%$deptdevice%' AND device_type like '%LT%'  ";
...
<!-- count prt-->
<?php
$query_total_device_prt = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE phongban.dept_id like '%$deptdevice%' AND device_type like '%prt%'  ";
...
!-- count orther-->
<?php
$query_total_device_orther_device = "SELECT * from device join phongban on device.dept=phongban.dept_id WHERE phongban.dept_id like '%$deptdevice%' AND device_type like '%DV%'  ";
...
!-- count thanh lý-->
<?php
$query_total_device_thanhly = "SELECT * from thanhly_device ";

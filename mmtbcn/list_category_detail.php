...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  ?>
    <tr>
      ...
      if ( $_SESSION['admin_cn_mmtb'] >= 2 || $_SESSION['admin'] >= 3) {      
      ?>
      <td><a href="updatecategory.php?category_detail=<?php echo $row['category_detail_id']; ?>&func=update-category" target="_blank"><font size="6" color="green"><i class="fa fa-pencil-square"></i> </font></a>
        <a href="updatecategory.php?category_detail=<?php echo $row['category_detail_id']; ?>&func=remove-category" target="_blank"><font size="6" color="red"><i class="fa fa-trash-o"></i> </font></a>
      </td>  
      <?php
  }
  ?>
...
{
    if($phongban == $_SESSION['staff_location'])
    {
    if($phongban == "cty")
    {
        $query_dept = "SELECT * from cn_phongban WHERE dept_location <> 'cty'" ;
    }
    else
    {
        $query_dept = "SELECT * from cn_phongban WHERE dept_location='$phongban' and dept_location <> 'cty'" ;
    }
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  ?>
    <tr>
      ...
      <td style="text-align:center;"><?php if( $row_dept['dept_location'] ==  "CNMB" || $row_dept['dept_location'] ==  "cnmb" )
      {
        echo "Chi Nhánh Miền Bắc" ; 
      }
      elseif($row_dept['dept_location'] ==  "CNMT" || $row_dept['dept_location'] ==  "cnmt")
      {
        echo "Chi Nhánh Miền Tây" ;
      }
      elseif($row_dept['dept_location'] ==  "CNTN" || $row_dept['dept_location'] ==  "cntn")
      {
        echo "Chi Nhánh Miền Trung - Tây Nguyên" ;
      }
      elseif($row_dept['dept_location'] ==  "CNMN" || $row_dept['dept_location'] ==  "cnmn")
      {
        echo "Chi Nhánh Miền Nam" ;
      }
      elseif($row_dept['dept_location'] ==  "CNTP" || $row_dept['dept_location'] ==  "cntp")
      {
      ...
      if ( $_SESSION['admin_cn_mmtb'] >= 2 || $_SESSION['admin'] >= 3 ) {      
      ?>
      <td><a href="updatedept.php?dept=<?php echo $row_dept['dept_id']; ?>&func=update-dept" target="_blank"><font size="6" color="green"><i class="fa fa-pencil-square"></i> </font></a>
        <a href="updatedept.php?dept=<?php echo $row_dept['dept_id']; ?>&func=remove-dept" target="_blank"><font size="6" color="red"><i class="fa fa-trash-o"></i> </font></a>
      </td>  
      <?php
  }
  ?>

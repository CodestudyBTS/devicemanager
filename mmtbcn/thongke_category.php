<?php       
        ...
        {
            if( $_SESSION['admin_cn_mmtb'] >= 1 || $_SESSION['admin'] >= 3)
            {
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
        	...
        	{
        	?>
        	<li><a href="../mmtb/thongke_category.php?phongban=list_dept"><em class="fa fa-building">&nbsp;</em> Danh sách phòng ban công ty</a></li>
        	<?php 
        	}
        	?>
        	<li><a href="thongke_category.php?phongban=<?php echo $_SESSION['staff_location'] ; ?>"><em class="fa fa-building">&nbsp;</em> Danh sách phòng ban chi nhánh</a></li>
        </ul>

<?php       
        ...
        if($phongban == "cty")
        {
        	 $query_dept = "SELECT * FROM network_dept WHERE network_dept <> 'cty' ";
        }	
        else
        {
        	$query_dept = "SELECT * FROM network_dept WHERE network_dept='$phongban' and  network_dept <> 'cty' "  ;
        }
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		?>
        	...
        	<li><a href="thongke_device.php"><em class="fa fa-bookmark">&nbsp;</em> Tổng hợp</a></li>
		<?php
		}
			while($row_dept = mysqli_fetch_assoc($result_dept))				
        {
        	?>
        	<li><a href="thongke_device.php?deptdevice=<?php echo $row_dept['network_dept'] ; ?>"><em class="fa fa-building">&nbsp;</em><?php echo $row_dept['network_dept_detail'] ;?></a></li>
        	<?php
        }
        ?>
	 ...
	 <?php
	 	require('xuly_thongke_device.php');

<?php   
        ...
        if (isset($_SESSION['username']))        {     
            $query_total = "SELECT *, DATE_FORMAT(update_date, '%d-%m-%Y') as update_date from cn_thanhly_device WHERE dept_location='$deptdevice'" ;      
...
<head>        
        ...
        <title>Danh sách linh kện thanh lý</title>

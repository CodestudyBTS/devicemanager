...
$dept_site = addslashes($_POST['txtsite']);
...
exit;
        ...
        $query_is_dept = "SELECT dept_name from cn_phongban  WHERE dept_name='$dept_name'" ;
        $result_is_dept = mysqli_query($connect, $query_is_dept) ;
        $row_is_dept = mysqli_fetch_array($result_is_dept);
        if (is_null($row_is_dept))      
        {   
        $query_is_dept = "INSERT INTO cn_phongban (dept_site, dept_name,  dept_location , Note_phongban, update_date, staff_update) VALUES ('$dept_site',  '$dept_name', '$dept_location', '$note', '$date', '$staff') ";
...
header("Location: thongke_category.php?phongban=$location_cn");
}
...
exit;
        ...
        $query_ud_dept = "UPDATE  cn_phongban SET dept_site='$dept_site', dept_name='$dept_name', dept_location='$dept_location', Note_phongban='$note', update_date='$date', staff_update='$staff' WHERE dept_id ='$dept_id'";
...
exit;
        ...
        $query_del_dept = "DELETE FROM  cn_phongban WHERE dept_id ='$dept_id'";

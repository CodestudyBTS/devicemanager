...
<body>
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
                <div class="container-fluid">
                        <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="thongke_ticket.php"><span>Analysis Ticket Rated Detail </span>Admin</a>                              
                </div>
                </div><!-- /.container-fluid -->
        </nav>
        <div class="col-lg-12">
  ...
  ?>
    <tr>
      ...
      if ( $_SESSION['admin_rating'] == 2 ) {      
      ?>
      <td><a href="../admin_rating/updaterating.php?ticket_id=<?php echo $row['ticket_id']; ?>" target="_blank"><font size="6" color="green"><i class="fa fa-pencil-square"></i> </font></a></td>  
      <?php
  }
  ?>
    </tr> 
